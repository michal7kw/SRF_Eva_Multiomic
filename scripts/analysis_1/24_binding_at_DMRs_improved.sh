#!/bin/bash
#SBATCH --job-name=a1_24_binding_DMRs_imp
#SBATCH --account=kubacki.michal
#SBATCH --partition=workq
#SBATCH --time=4:00:00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=16
#SBATCH --output=logs/24_binding_at_DMRs_improved.out
#SBATCH --error=logs/24_binding_at_DMRs_improved.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=kubacki.michal@hsr.it

echo "=========================================="
echo "TES/TEAD1 BINDING AT DMRs (IMPROVED)"
echo "=========================================="
...
echo "         (Using improved BigWigs from merged BAMs)"
echo ""
...
# Output directory
OUTDIR="output/24_binding_at_DMRs_improved"
...
# Cut&Tag BigWig files (binding) - IMPROVED SOURCE
CUTANDTAG_BIGWIG="/beegfs/scratch/ric.sessa/kubacki.michal/SRF_Eva_top/SRF_Eva_CUTandTAG/results/11_combined_replicates_narrow/bigwig"
TES_BIND="${CUTANDTAG_BIGWIG}/TES_average.bw"
TEAD1_BIND="${CUTANDTAG_BIGWIG}/TEAD1_average.bw"
