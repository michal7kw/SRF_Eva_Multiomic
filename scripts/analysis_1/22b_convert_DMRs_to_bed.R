...
write.table(bed_direction,
            file.path(output_dir, "DMRs_by_direction.bed"),
...
write.table(bed_TES,
            file.path(output_dir, "DMRs_by_TES_peak.bed"),
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
write.table(bed_TEAD1,
            file.path(output_dir, "DMRs_by_TEAD1_peak.bed"),
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
write.table(bed_combined,
            file.path(output_dir, "DMRs_by_peak_category.bed"),
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
write.table(bed_simple,
            file.path(output_dir, "DMRs_simple.bed"),
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
