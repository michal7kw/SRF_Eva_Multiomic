...
required_files=(
  "SRF_Eva_integrated_analysis/output/true_gsea_analysis/fgsea_all_pathways.csv"
  "SRF_Eva_RNA/results/06_directional_go/upregulated_GO_BP.csv"
  "SRF_Eva_integrated_analysis/output/results/direct_targets/TES_direct_targets_all_genes.csv"
)
...
if [ $missing_files -gt 0 ]; then
  ...
  echo "  sbatch SRF_Eva_integrated_analysis/scripts/run_true_gsea.sh"
  echo "  sbatch SRF_Eva_RNA/scripts/run_directional_go.sh"
  echo "  sbatch SRF_Eva_integrated_analysis/scripts/run_deg_only_analysis.sh"
  echo ""
  exit 1
fi
...
if Rscript SRF_Eva_integrated_analysis/scripts/enhanced_gsea_visualizations.R; then
...
if Rscript SRF_Eva_RNA/scripts/enhanced_directional_go.R; then
...
if Rscript SRF_Eva_integrated_analysis/scripts/enhanced_integrative_plots.R; then
...
echo "-----------------"
echo "GSEA plots:"
echo "  ${BASE_DIR}/SRF_Eva_integrated_analysis/output/true_gsea_analysis/enhanced_plots/"
echo ""
...
echo "  ${BASE_DIR}/SRF_Eva_integrated_analysis/output/enhanced_integrative_plots/"
echo ""
...
gsea_count=$(find SRF_Eva_integrated_analysis/output/true_gsea_analysis/enhanced_plots/ -type f 2>/dev/null | wc -l)
go_count=$(find SRF_Eva_RNA/results/06_directional_go/enhanced_plots/ -type f 2>/dev/null | wc -l)
int_count=$(find SRF_Eva_integrated_analysis/output/enhanced_integrative_plots/ -type f 2>/dev/null | wc -l)
interactive_count=$(find SRF_Eva_RNA/results/06_directional_go/interactive/ -name "*.html" 2>/dev/null | wc -l)
