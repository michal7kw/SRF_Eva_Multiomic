...
load("SRF_Eva_CUTandTAG/results/advanced_analysis/01_binding_classification/binding_classification_data.RData")
...
OUTPUT_DIR <- "SRF_Eva_integrated_analysis/advanced/03_methylation_binding"
