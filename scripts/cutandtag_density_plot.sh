#!/bin/bash
#SBATCH --job-name=cutandtag_density
...
#SBATCH --output=logs/cutandtag_density.out
#SBATCH --error=logs/cutandtag_density.err
...
Rscript scripts/cutandtag_density_plot.R
