...
#SBATCH --output=SRF_Eva_integrated_analysis/focused_enrichment_analysis/logs/approach6.out
#SBATCH --error=SRF_Eva_integrated_analysis/focused_enrichment_analysis/logs/approach6.err
