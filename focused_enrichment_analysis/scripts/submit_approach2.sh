...
#SBATCH --output=SRF_Eva_integrated_analysis/focused_enrichment_analysis/logs/approach2.out
#SBATCH --error=SRF_Eva_integrated_analysis/focused_enrichment_analysis/logs/approach2.err
